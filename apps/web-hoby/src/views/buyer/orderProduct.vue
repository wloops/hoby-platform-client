...
function viewSource(row: OrderItem) {
  // router.push(`/buyer/goodsSource/${row.id}`);
  // router.push({
  //   name: 'BuyerGoodsSource',
  //   params: { id: row.id },
  // });
  ...
  <div class="flex h-full flex-col overflow-hidden">
    <div class="mb-4 flex items-center justify-between">
      <div class="flex items-center gap-2">
        <button
          class="m-2 mb-0 flex items-center gap-1 text-gray-600 hover:text-blue-500"
          @click="router.back()"
        >
    ...
    <div class="flex-1 overflow-hidden rounded-lg bg-white shadow-sm">
      <!-- 订单信息 -->
      <div class="mb-1 flex items-center justify-between rounded-lg pl-2 pr-2">
        <div class="text-gray-600">销售订单号：147524081311232011140</div>
