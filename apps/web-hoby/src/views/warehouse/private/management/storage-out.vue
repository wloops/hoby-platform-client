 ...
 * @LastEditTime: 2025-03-18 17:29:45
...
const pageTitle = $t('page.warehouse.myPrivateWarehouse.management.storageOut');
// 表格列配置
...
const warehouseApi = {
  getList: async (_params: SearchParams) => {
    ...
    const params = {
      pageID: 'privateWareWaitingDialOutPage',
      pageDataGrpID: 'privateWareWaitingDialOut',
      ..._params,
    };
