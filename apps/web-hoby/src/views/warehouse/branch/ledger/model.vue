 ...
 * @LastEditTime: 2025-03-20 13:45:10
 * @FilePath: \hoby-platform-client\apps\web-hoby\src\views\warehouse\branch\ledger\model.vue
...
const warehouseApi = {
  getList: async (_params: SearchParams) => {
    ...
    const params = {
      pageID: 'branchWarehouseStoreSrlIDPage',
      pageDataGrpID: 'branchWarehouseStoreSrlID',
      ..._params,
    };
