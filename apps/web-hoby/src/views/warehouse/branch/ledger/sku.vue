 ...
 * @LastEditTime: 2025-03-19 11:18:33
 * @FilePath: \hoby-platform-client\apps\web-hoby\src\views\warehouse\branch\ledger\sku.vue
...
const warehouseApi = {
  getList: async (_params: SearchParams) => {
    ...
    const params = {
      pageID: 'branchWarehouseStoreSKUPage',
      pageDataGrpID: 'branchWarehouseStoreSKU',
      ..._params,
    };
