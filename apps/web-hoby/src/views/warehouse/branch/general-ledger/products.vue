 ...
 * @LastEditTime: 2025-03-20 13:48:46
 * @FilePath: \hoby-platform-client\apps\web-hoby\src\views\warehouse\branch\general-ledger\products.vue
...
const productApi = {
  getList: async (_params: SearchParams) => {
    ...
    const params = {
      pageID: 'branchWareStoreProductPage',
      pageDataGrpID: 'branchWareStoreProduct',
      ..._params,
    };
