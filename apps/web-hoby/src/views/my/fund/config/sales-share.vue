...
/**
 * @pageName pageName=销售收入分成规则页面
 * @pageID pageID=salesRevenueShareRulePage
 * @remark 视图=HOBY销售收入分成规则界面（hobySaleDivideRule：1654）
 */
const tableProps = ref<CommonTableProps>({
  // 基础配置(必填) CommonTableParams
  params: {
    pageID: 'salesRevenueShareRulePage', // 页面ID
