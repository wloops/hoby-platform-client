...
/**
 * @pageName pageName=本机构待收款销售订单结算凭证页面
 * @pageID pageID=mySettleVoucherWaitRcvMoneyPage
 * @remark 视图=HOBY销售订单结算凭证-待收款界面（zcyPurchaseOrderSettleBill：9001）
 */
const tableProps = ref<CommonTableProps>({
  // 基础配置(必填) CommonTableParams
  params: {
    pageID: 'mySettleVoucherWaitRcvMoneyPage', // 页面ID
