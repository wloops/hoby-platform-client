...
/**
 * @pageName pageName=本机构待付款采购订单结算凭证页面
 * @pageID pageID=mySettleVoucherWaitPayPage
 * @remark 视图=HOBY本机构采购订单结算凭证-待付款界面（zcyPurchaseOrderSettleBill：9001）
 */
const tableProps = ref<CommonTableProps>({
  // 基础配置(必填) CommonTableParams
  params: {
    pageID: 'mySettleVoucherWaitPayPage', // 页面ID
