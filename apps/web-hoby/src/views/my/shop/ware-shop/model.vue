 ...
 * @LastEditTime: 2025-03-21 16:48:17
 * @FilePath: \hoby-platform-client\apps\web-hoby\src\views\shop\private\model.vue
...
const pageTitle = $t('page.shop.myPrivateWarehouse.model');
...
const warehouseApi = {
  getList: async (_params: SearchParams) => {
    const params = {
      pageID: 'myPrivateWareShopSrlIDPage',
      pageDataGrpID: 'myPrivateWareShopSrlID',
      ..._params,
    };
