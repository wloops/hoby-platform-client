 ...
 * @LastEditTime: 2025-03-20 16:46:09
 * @FilePath: \hoby-platform-client\apps\web-hoby\src\views\shop\private\products.vue
...
const pageTitle = $t('page.shop.myPrivateWarehouse.products');
...
const warehouseApi = {
  getList: async (_params: SearchParams) => {
    const params = {
      ...
      pageDataGrpID: 'myPrivateWareShopProduct',
      ..._params,
    };
