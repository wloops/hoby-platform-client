 ...
 * @Date: 2025-04-10 14:23:23
 * @LastEditors: Loong wentloop@gmail.com
 * @LastEditTime: 2025-04-10 14:50:47
 * @FilePath: \hoby-platform-client\apps\web-hoby\src\views\shop\order\all.vue
...
const tableProps = ref<CommonTableProps>({
  ...
  params: {
    pageID: 'sellerAllSaleOrderPage', // 页面ID
