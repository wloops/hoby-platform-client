 ...
 * @LastEditTime: 2025-04-10 14:35:18
 * @FilePath: \hoby-platform-client\apps\web-hoby\src\views\shop\order\pendingShipment.vue
...
const tableProps = ref<CommonTableProps>({
  ...
  params: {
    pageID: 'sellerWaitDistributionOrderPage', // 页面ID
