 ...
 * @LastEditTime: 2025-04-10 14:41:34
 * @FilePath: \hoby-platform-client\apps\web-hoby\src\views\shop\order\pendingPayment.vue
...
/**
 * @pageName sellerWaitSignForGoodsOrderPage
 * @pageID 示例页面ID
 * @remark 示例页面备注
 */
