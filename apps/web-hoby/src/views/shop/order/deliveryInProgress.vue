 ...
 * @LastEditTime: 2025-04-10 14:39:25
 * @FilePath: \hoby-platform-client\apps\web-hoby\src\views\shop\order\deliveryInProgress.vue
...
/**
 * @pageName 界面::卖方配送中的销售订单页面
 * @pageID sellerDeliveringOrderPage
 * @remark 示例页面备注
 */
const tableProps = ref<CommonTableProps>({
  // 基础配置(必填) CommonTableParams
  params: {
    pageID: 'sellerDeliveringOrderPage', // 页面ID
