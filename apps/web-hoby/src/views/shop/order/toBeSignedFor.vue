 ...
 * @Date: 2025-04-09 10:51:23
 * @LastEditors: Loong wentloop@gmail.com
 * @LastEditTime: 2025-04-10 14:41:00
 * @FilePath: \hoby-platform-client\apps\web-hoby\src\views\shop\order\toBeSignedFor.vue
...
/**
 * @pageName 界面::卖方待签收的销售订单页面
 * @pageID sellerWaitSignForGoodsOrderPage
 * @remark 示例页面备注
 */
const tableProps = ref<CommonTableProps>({
  // 基础配置(必填) CommonTableParams
  params: {
    pageID: 'sellerWaitSignForGoodsOrderPage', // 页面ID
